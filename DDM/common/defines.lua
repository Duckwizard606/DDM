...
country = {
	...
	NONCORE_TAX_PENALTY = -0.5, -- -5% for each non-core in state
	...
	INVESTMENT_SCORE_FACTOR = 0.1, -- how much foreign investment money counts towards your industry score
	...
	NEWSPAPER_PRINTING_FREQUENCY = 36000, -- days frequency when the news attempt to be printed (may not print if not enough facts collected, and retry after another X days)
	...
	MOBILIZATION_SPEED_RAILS_MULT = 8.0, -- Speed modifier for raising troops. It's max value for max railways level in state.
...
economy = {
	...
	MIN_NUM_FACTORIES_PER_STATE_BEFORE_DELETING_LASSIEZ_FAIRE = 3, -- Min number of factories per state before starting to delete under Lassiez Faire
	...
	FACTORY_UPGRADE_EMPLOYEE_FACTOR = 0.55, -- determines how close to the employee limit we need to be before "upgrade all" will upgrade/expand a given factory (1 = 100%).
...
military = {
	...
	POP_MIN_SIZE_FOR_REGIMENT_COLONY_MULTIPLIER = 9,
	...
	LEADER_PRESTIGE_LAND_GAIN = 2, -- extra speed gain on prestige for land combat
	LEADER_PRESTIGE_NAVAL_GAIN = 2, -- extra speed gain on prestige for naval combat
...
diplomacy = {
	...
	ON_CB_DETECTED_RELATION_CHANGE = -200, -- relations decreased when CB detected.
	...
	AT_WAR_TENSION_DECAY = -0.20, -- for each potentially interested GP at war (value is if all possible GPs are at war) 
	TENSION_ON_CB_DISCOVERED = 10,
...
pops = {
	...
	MIL_REQUIRE_REFORM = 0.20,
	MIL_IDEOLOGY = 0,
	MIL_RULING_PARTY = -0.2,
	MIL_REFORM_IMPACT = 2,
	...
	MIL_TO_AUTORISE = 20, -- Rebels over this rise no matter what
...
ai =
{
	...
	FLEET_SIZE = 80, -- AI will attempt to keep fleets of roughly this size (fewer fleets generally results in more competent naval AI)
